...
public class LatencyConnection implements Connection {
    ...
    LatencyConnection(Connection realConnection, LatencySimulator latencySimulator) {
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new LatencyPreparedStatement(realConnection.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), latencySimulator);
    }

    @Override
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new LatencyCallableStatement(realConnection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability), latencySimulator);
    }
